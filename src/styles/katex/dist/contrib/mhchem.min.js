!(function (t, e) {
  ...
  return (function () {
    ...
    var a = {},
      r = o(757),
      i = o.n(r);
    (i().__defineMacro('\\ce', function (t) {
      return c(t.consumeArgs(1)[0], 'ce');
    }),
      i().__defineMacro('\\pu', function (t) {
        return c(t.consumeArgs(1)[0], 'pu');
      }),
      i().__defineMacro(
        '\\tripledash',
    ...
    var c = function (t, e) {
      ...
      u = {
        go: function (t, e) {
          ...
          for (var r = 10, i = []; ; ) {
            n !== t ? ((r = 10), (n = t)) : r--;
            var c = u.stateMachines[e],
              p = c.transitions[o] || c.transitions['*'];
            t: for (var s = 0; s < p.length; s++) {
              var _ = u.patterns.match_(p[s].pattern, t);
              if (_) {
                for (var d = p[s].task, m = 0; m < d.action_.length; m++) {
                  var l;
                  if (c.actions[d.action_[m].type_])
                    l = c.actions[d.action_[m].type_](
                      a,
                      _.match_,
                      d.action_[m].option,
                    );
                ...
                if (((o = d.nextState || o), !(t.length > 0))) return i;
        ...
        patterns: {
          patterns: {
            ...
            'state of aggregation $': function (t) {
              var e = u.patterns.findObserveGroups(
                t,
                '',
                /^\([a-z]{1,3}(?=[\),])/,
                ')',
            ...
            '* ': /^([*])\s*/,
            '^{(...)}': function (t) {
              return u.patterns.findObserveGroups(t, '^{', '', '', '}');
            },
            '^($...$)': function (t) {
              return u.patterns.findObserveGroups(t, '^', '$', '$', '');
            },
            '^a': /^\^([0-9]+|[^\\_])/,
            '^\\x{}{}': function (t) {
              return u.patterns.findObserveGroups(
                t,
                '^',
                /^\\[a-zA-Z]+\{/,
                '}',
            ...
            "'": /^'/,
            '_{(...)}': function (t) {
              return u.patterns.findObserveGroups(t, '_{', '', '', '}');
            },
            '_($...$)': function (t) {
              return u.patterns.findObserveGroups(t, '_', '$', '$', '');
            },
            ...
            arrowUpDown: /^(?:v|\(v\)|\^|\(\^\))(?=$|[\s,;\)\]\}])/,
            '\\bond{(...)}': function (t) {
              return u.patterns.findObserveGroups(t, '\\bond{', '', '', '}');
            },
            '->': /^(?:<->|<-->|->|<-|<=>>|<<=>|<=>|[\u2192\u27F6\u21CC])/,
            CMT: /^[CMT](?=\[)/,
            '[(...)]': function (t) {
            ...
            '\\color{(...)}0': function (t) {
              return u.patterns.findObserveGroups(t, '\\color{', '', '', '}');
            },
            '\\color{(...)}{(...)}1': function (t) {
              return u.patterns.findObserveGroups(
                t,
            ...
            '\\ce{(...)}': function (t) {
              return u.patterns.findObserveGroups(t, '\\ce{', '', '', '}');
            },
            ...
            amount: function (t) {
              ...
              var n = u.patterns.findObserveGroups(t, '', '$', '$', '');
              return n &&
                (e = n.match_.match(
          ...
          match_: function (t, e) {
            var n = u.patterns.patterns[t];
            if (void 0 === n)
              throw ['MhchemBugP', 'mhchem bug P. Please report. (' + t + ')'];
            if ('function' == typeof n) return u.patterns.patterns[t](e);
            var o = e.match(n);
            return o
              ? {
        ...
        actions: {
          ...
          '{text}': function (t, e) {
            var n = ['{'];
            return (u.concatArray(n, u.go(e, 'text')), n.push('}'), n);
          },
          'tex-math': function (t, e) {
            return u.go(e, 'tex-math');
          },
          'tex-math tight': function (t, e) {
            return u.go(e, 'tex-math tight');
          },
          bond: function (t, e, n) {
    ...
    u.stateMachines = {
      ce: {
        transitions: u.createTransitions({
        ...
        actions: {
          ...
          'charge or bond': function (t, e) {
            if (t.beginsWithBond) {
              var n = [];
              return (
                u.concatArray(n, this.output(t)),
                u.concatArray(n, u.actions.bond(t, e, '-')),
                n
              );
            }
            t.d = e;
          ...
          '- after o/d': function (t, e, n) {
            var o = u.patterns.match_('orbital', t.o || ''),
              a = u.patterns.match_('one lowercase greek letter $', t.o || ''),
              r = u.patterns.match_('one lowercase latin letter $', t.o || ''),
              i = u.patterns.match_(
                '$one lowercase latin letter$ $',
                t.o || '',
              ),
              c = '-' === e && ((o && '' === o.remainder) || a || r || i);
            !c ||
              t.a ||
              t.b ||
              t.p ||
            ...
            return (
              c
                ? (u.concatArray(p, this.output(t)),
                  p.push({ type_: 'hyphen' }))
                : ((o = u.patterns.match_('digits', t.d || '')),
                  n && o && '' === o.remainder
                    ? (u.concatArray(p, u.actions['d='](t, e)),
                      u.concatArray(p, this.output(t)))
                    : (u.concatArray(p, this.output(t)),
                      u.concatArray(p, u.actions.bond(t, e, '-')))),
              p
            );
          },
          'a to o': function (t) {
          ...
          'state of aggregation': function (t, e) {
            return { type_: 'state of aggregation', p1: u.go(e, 'o') };
          },
          comma: function (t, e) {
            var n = e.replace(/\s*$/, '');
                ...
                (t.a || t.b || t.p || t.o || t.q || t.d || n) &&
                  ...
                  t.o || t.q || t.d || t.b || t.p || 2 === n
                    ? t.o || t.q || t.d || (!t.b && !t.p)
                      ? t.o &&
                        'kv' === t.dType &&
                        u.patterns.match_('d-oxidation$', t.d || '')
                        ? (t.dType = 'oxidation')
                  ...
                  o.push({
                    ...
                    o: u.go(t.o, 'o'),
                    q: u.go(t.q, 'pq'),
                    d: u.go(t.d, 'oxidation' === t.dType ? 'oxidation' : 'bd'),
                    dType: t.dType,
                  })));
            for (var i in t)
          ...
          'oxidation-output': function (t, e) {
            var n = ['{'];
            return (u.concatArray(n, u.go(e, 'oxidation')), n.push('}'), n);
          },
          'frac-output': function (t, e) {
            return { type_: 'frac-ce', p1: u.go(e[0]), p2: u.go(e[1]) };
          },
          'overset-output': function (t, e) {
            return { type_: 'overset', p1: u.go(e[0]), p2: u.go(e[1]) };
          },
          'underset-output': function (t, e) {
            return { type_: 'underset', p1: u.go(e[0]), p2: u.go(e[1]) };
          },
          'underbrace-output': function (t, e) {
            return { type_: 'underbrace', p1: u.go(e[0]), p2: u.go(e[1]) };
          },
          'color-output': function (t, e) {
            return { type_: 'color', color1: e[0], color2: u.go(e[1]) };
          },
          'r=': function (t, e) {
            t.r = e;
          },
      ...
      pq: {
        ...
        actions: {
          ...
          'color-output': function (t, e) {
            return { type_: 'color', color1: e[0], color2: u.go(e[1], 'pq') };
          },
        },
      },
      bd: {
        ...
        actions: {
          'color-output': function (t, e) {
            return { type_: 'color', color1: e[0], color2: u.go(e[1], 'bd') };
          },
        },
      },
      oxidation: {
      ...
      pu: {
        ...
        actions: {
          enumber: function (t, e) {
            ...
            return (
              '+-' === e[0] || '+/-' === e[0]
                ...
                : e[0] && n.push(e[0]),
              e[1] &&
                (u.concatArray(n, u.go(e[1], 'pu-9,9')),
                e[2] &&
                  (e[2].match(/[,.]/)
                    ? u.concatArray(n, u.go(e[2], 'pu-9,9'))
                    : n.push(e[2])),
                (e[3] = e[4] || e[3]),
                e[3] &&
                  ((e[3] = e[3].trim()),
          ...
          output: function (t) {
            var e,
              n = u.patterns.match_('{(...)}', t.d || '');
            n && '' === n.remainder && (t.d = n.match_);
            var o = u.patterns.match_('{(...)}', t.q || '');
            if (
              ...
              var a = { d: u.go(t.d, 'pu'), q: u.go(t.q, 'pu') };
              '//' === t.o
    ...
    var p = {
      go: function (t, e) {
        ...
        for (var n = '', o = !1, a = 0; a < t.length; a++) {
          ...
          'string' == typeof r
            ? (n += r)
            : ((n += p._go2(r)), '1st-level escape' === r.type_ && (o = !0));
        }
        return (e || o || !n || (n = '{' + n + '}'), n);
      },
      _goInner: function (t) {
      ...
      _go2: function (t) {
        ...
        switch (t.type_) {
          ...
          case 'pu-frac':
            var a =
              '\\frac{' + p._goInner(t.p1) + '}{' + p._goInner(t.p2) + '}';
            e =
              '\\mathchoice{\\textstyle' +
              a +
              '}{' +
          ...
          case 'underset':
            e =
              '\\underset{' + p._goInner(t.p1) + '}{' + p._goInner(t.p2) + '}';
            break;
          case 'underbrace':
            e =
              '\\underbrace{' +
          ...
          case 'color0':
            ...
            break;
          case 'arrow':
            var r = { rd: p._goInner(t.rd), rq: p._goInner(t.rq) },
              i = '\\x' + p._getArrow(t.r);
            (r.rq && (i += '[{' + r.rq + '}]'),
              (e = i += r.rd ? '{' + r.rd + '}' : '{}'));
            break;
