(function webpackUniversalModuleDefinition(root, factory) {
  ...
  function (__WEBPACK_EXTERNAL_MODULE__757__) {
    return /******/ (function () {
      // webpackBootstrap
      /******/ 'use strict';
      ...
      var external_katex_default =
        /*#__PURE__*/ __webpack_require__.n(external_katex_); // CONCATENATED MODULE: ./contrib/auto-render/splitAtDelimiters.js
      ...
      /* harmony default export */ var auto_render_splitAtDelimiters =
        splitAtDelimiters; // CONCATENATED MODULE: ./contrib/auto-render/auto-render.js
      /* eslint no-console:0 */
      ...
      const renderMathInText = function (text, optionsCopy) {
        const data = auto_render_splitAtDelimiters(
          text,
