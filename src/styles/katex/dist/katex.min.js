!(function (e, t) {
  ...
  return (function () {
    ...
    function ie(e, t, r, n, o, s) {
      ((oe[e][o] = { font: t, group: r, replace: n }),
        s && n && (oe[e][n] = oe[e][o]));
    }
    const ae = 'math',
      le = 'text',
    ...
    for (let e = 0; e < 52; e++) {
      ...
      ((Ae = String.fromCharCode(55349, 56320 + e)),
        ...
        ie(le, he, ve, t, Ae),
        e < 26 &&
          ((Ae = String.fromCharCode(55349, 56632 + e)),
          ie(ae, he, ge, t, Ae),
          ie(le, he, ve, t, Ae),
    ...
    const Be = [
      ...
      Ne = function (e, t, r) {
        return (
          se[r][e] && se[r][e].replace && (e = se[r][e].replace),
    ...
    const Ke = function (e) {
        ...
        return (
          st(
            ...
            (e, t) => {
              const r = t.classes[0],
                n = e.classes[0];
              'mbin' === r && l.contains(tt, n)
                ? (t.classes[0] = 'mord')
                : 'mbin' === n && l.contains(et, r) && (e.classes[0] = 'mord');
            },
            { node: i },
            a,
            h,
      ...
      it = function (e) {
        return e instanceof A ||
          e instanceof j ||
          (e instanceof _ && e.hasClass('enclosing'))
          ? e
          : null;
      },
      at = function (e, t) {
      ...
      mathmlBuilder: (e, t) => {
        ...
        if (
          (e.totalheight.number > 0 &&
            ((o = P(e.totalheight, t) - n), r.setAttribute('valign', F(-o))),
    ...
    const en = (e, t, r, n, o, s, i) => {
      ...
      rn = (e, t) => {
        ...
        let c = 0,
          m = 0;
        return (
          (a instanceof K || '\\oiint' === o.name || '\\oiiint' === o.name) &&
            !o.suppressBaseShift &&
            ((c = (a.height - a.depth) / 2 - t.fontMetrics().axisHeight),
            (m = a.italic)),
          s
            ? en(a, r, n, t, i, m, c)
            : (c && ((a.style.position = 'relative'), (a.style.top = F(c))), a)
        );
      },
      nn = (e, t) => {
        let r;
    ...
    (Nr('\\newcommand', (e) => Nn(e, !1, !0, !1)),
      ...
      Nr('\\show', (e) => {
        const t = e.popToken(),
          r = t.text;
        return (
          console.log(t, e.macros.get(r), wn[r], se.math[r], se.text[r]),
          ''
        );
      }),
      Nr('\\bgroup', '{'),
    ...
    Nr('\\dots', function (e) {
      ...
      return (
        r in qn
          ? (t = qn[r])
          : ('\\not' === r.slice(0, 4) ||
              (r in se.math && l.contains(['bin', 'rel'], se.math[r].group))) &&
            (t = '\\dotsb'),
        t
      );
    });
    ...
    class En {
      ...
      isDefined(e) {
        return (
          this.macros.has(e) ||
          wn.hasOwnProperty(e) ||
          se.math.hasOwnProperty(e) ||
          se.text.hasOwnProperty(e) ||
          On.hasOwnProperty(e)
        );
      }
      isExpandable(e) {
